...
export const OrderCompletionScreen: React.FC<OrderCompletionScreenProps> = ({
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-emerald-50 via-teal-50 to-blue-50 overflow-hidden">
      {/* Confetti */}
      <AnimatePresence>
        {showConfetti && (
          <>
      ...
      <div className="relative z-10 max-w-md mx-auto px-4 pt-12 pb-8 space-y-6">
        ...
        >
          <div className="relative">
            <div className="w-28 h-28 rounded-full bg-gradient-to-br from-emerald-400 to-teal-500 flex items-center justify-center shadow-2xl shadow-emerald-500/30">
        ...
        >
          <h1 className="text-3xl font-black text-slate-900">Thank You for Ordering!</h1>
          <p className="text-base text-slate-600 font-medium">
            Your order has been successfully collected.
          </p>
          <p className="text-sm text-slate-500">
            We hope you enjoyed your meal. <br />
            Thank you for choosing <span className="font-bold text-emerald-600">FOODEXA</span>.
          </p>
          <p className="text-xs text-slate-400 font-semibold">Have a wonderful day!</p>
        </motion.div>
        ...
        <motion.div
          ...
          className="rounded-3xl bg-white/70 backdrop-blur-xl border border-white/60 p-6 shadow-xl shadow-slate-200/50 space-y-5"
        >
          {/* Order Number */}
          <div className="text-center pb-4 border-b border-slate-200/60">
            ...
            <p className="text-2xl font-black text-slate-900 tracking-tight">{orderNumber}</p>
          </div>

          {/* Pickup & Token */}
          <div className="grid grid-cols-2 gap-3">
            {pickupCode && (
              <div className="rounded-2xl bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-200/50 p-4 text-center">
            ...
            {tokenNumber && (
              <div className="rounded-2xl bg-gradient-to-br from-amber-50 to-orange-50 border border-amber-200/50 p-4 text-center">
          ...
          <div className="space-y-3">
            ...
            {order.counter && (
              <div className="flex items-center gap-3 p-3 rounded-xl bg-slate-50/80">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-[10px] font-bold text-slate-400 uppercase">Canteen / Counter</p>
            ...
            <div className="flex items-center justify-between p-3 rounded-xl bg-gradient-to-r from-emerald-50 to-teal-50 border border-emerald-200/50">
        ...
        >
          <button
            ...
            className="w-full flex items-center justify-center gap-2.5 py-4 rounded-2xl bg-gradient-to-r from-amber-500 to-orange-500 text-white font-bold text-sm shadow-lg shadow-amber-500/25 hover:from-amber-400 hover:to-orange-400 transition-all active:scale-[0.98]"
          >
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2.5 py-4 rounded-2xl bg-white border border-slate-200 text-slate-900 font-bold text-sm shadow-sm hover:bg-slate-50 transition-all active:scale-[0.98]"
          >
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2.5 py-4 rounded-2xl bg-slate-900 text-white font-bold text-sm shadow-lg hover:bg-slate-800 transition-all active:scale-[0.98]"
          >
            Continue Browsing
