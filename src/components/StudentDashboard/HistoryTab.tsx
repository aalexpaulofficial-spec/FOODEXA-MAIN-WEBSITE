                ...
                <div className="px-4 py-3 flex items-start justify-between border-b border-slate-100">
                  <div className="flex items-center gap-3">
                    <div className={`w-10 h-10 rounded-xl flex items-center justify-center ${
                      ...
                      {isCompleted ? <CheckCircle2 className="w-5 h-5 text-emerald-600" /> : isCancelled ? <XCircle className="w-5 h-5 text-red-500" /> : <Package className="w-5 h-5 text-slate-400" />}
                    </div>
                    <div>
                      <h3 className="font-black text-slate-900 text-sm">{orderNumber}</h3>
                  ...
                  <div className="space-y-1">
                    {order.items.slice(0, 3).map((item, i) => (
                      <div key={i} className="flex justify-between items-center text-xs">
                        <span className="text-slate-700 font-semibold truncate flex-1 pr-2">{item.quantity}x {item.name}</span>
                ...
                <div className="px-4 py-3 bg-slate-50/50 border-t border-slate-100 flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      className="flex items-center gap-1 px-3 py-2 rounded-xl border border-slate-200 bg-white text-xs font-bold text-slate-700 hover:bg-slate-50 transition-colors"
                    >
