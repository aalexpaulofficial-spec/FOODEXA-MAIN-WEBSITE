...
export const PremiumBottomNav: React.FC<PremiumBottomNavProps> = ({
  ...
  return (
    ...
    >
      <div className="flex items-center gap-0.5 bg-white/90 backdrop-blur-xl border border-slate-200/70 shadow-2xl shadow-slate-900/15 rounded-full px-1.5 py-1.5">
        {TABS.map(tab => {
          const Icon = tab.icon;
          ...
          return (
            <button
              ...
              style={active ? { boxShadow: '0 4px 12px rgba(59, 130, 246, 0.35)' } : undefined}
            >
